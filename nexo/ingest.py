...
from nexo.security import safe_fetch, safe_fetch_text, validate_url
...
def ingest(url: str, target_dir: Path, author: str | None = None, contributor: str | None = None) -> Path:
    """
    Fetch a URL and save it into target_dir as a nexo-ready file.
    ...
    try:
        ...
        if url_type == "youtube":
            from nexo.transcribe import download_audio
...
def save_query_result(
    ...
    that nexo's extractor reads as node metadata. This closes the feedback loop:

"""Token-reduction benchmark - measures how much context nexo saves vs naive full-corpus approach."""
...
def run_benchmark(
    graph_path: str = "nexo-out/graph.json",
    corpus_words: int | None = None,
    questions: list[str] | None = None,
) -> dict:
    """Measure token reduction: corpus tokens vs nexo query tokens.
...
def print_benchmark(result: dict) -> None:
    ...
    print(f"\nnexo token reduction benchmark")
    print(f"{'─' * 50}")
